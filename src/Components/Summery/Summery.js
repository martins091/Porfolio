    ...
    <section id="summery" data-aos="fade-right">
      <div className="summery-heading">
        ...
        {/* <h2>Cross-Browser Compatibility</h2>
                ...
                <h2>Collaboration</h2> */}
        <a
          href="https://drive.google.com/file/d/1JUp-jKaMLyLkPqNLpQ2Ik_Ccp2eg80Xf/view?usp=sharing"
          download
          className="btn-link"
          target="blank"
        >
      ...
      <div className="summery-details" data-aos="fade-left">
        <p>
          Proficiency in creating structured, semantic HTML and styling it using
          CSS for responsive and visually appealing layouts.
        </p>
        <p>
          Strong understanding of JavaScript and its libraries/frameworks (e.g.,
          React.js, Vue.js) to create dynamic and interactive user interfaces.
        </p>
        <p>
          Ability to design and develop websites and applications that function
          smoothly across various devices and screen sizes.
        </p>
        <p>
          Skill in creating intuitive and visually appealing user interfaces,
          considering user experience and usability principles.
        </p>
